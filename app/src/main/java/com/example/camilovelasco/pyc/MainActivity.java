...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_proximo_dia=(TextView)findViewById(R.id.text);
        ...
        if(Arrays.asList(FESTIVOS).contains(diaAnio) || diaSemana == 1 || diaSemana == 7) {
            ...
            picoYplacaHoy=PYP[localCalendar.get(Calendar.DAY_OF_YEAR)-2];//se resta dos porque lunes comienza el dia 2
        }
        tv1.setText(" "+picoYplacaHoy+" ");
        localCalendar.set(Calendar.DAY_OF_YEAR, diaAnio);//***************************Dia actual
    ...
    {
        Intent y = new Intent(this, ConfigActivity.class );
        startActivity(y);
    }
